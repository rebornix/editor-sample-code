 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "assert", "vs/base/browser/dom", "vs/base/common/uri", "vs/editor/browser/services/codeEditorServiceImpl", "vs/platform/theme/test/common/testThemeService"], function (require, exports, assert, dom, uri_1, codeEditorServiceImpl_1, testThemeService_1) {
    "use strict";
    ...
    exports.TestCodeEditorServiceImpl = TestCodeEditorServiceImpl;
    suite('Decoration Render Options', () => {
        ...
        function readStyleSheet(styleSheet) {
            if (styleSheet.sheet.rules) {
                return Array.prototype.map.call(styleSheet.sheet.rules, (r) => r.cssText).join('\n');
            }
        ...
        test('theme color', () => {
            ...
            let styleSheet = dom.createStyleSheet();
            let themeService = new testThemeService_1.TestThemeService(new testThemeService_1.TestTheme(colors));
        ...
        test('theme overrides', () => {
            ...
            s.registerDecorationType('example', options);
            let sheet = readStyleSheet(styleSheet);
            let expected = '.vs-dark.monaco-editor .ced-example-4::after, .hc-black.monaco-editor .ced-example-4::after { color: rgb(68, 68, 68) !important; }\n' +
