...
define(["require", "exports", "assert", "vs/base/common/uri", "vs/editor/common/services/languagesRegistry"], function (require, exports, assert, uri_1, languagesRegistry_1) {
    ...
    suite('LanguagesRegistry', () => {
        ...
        test('configuration', () => {
            ...
            assert.deepEqual(registry.getConfigurationFiles('a'), [uri_1.URI.file('/path/to/aFilename')]);
            ...
            assert.deepEqual(registry.getConfigurationFiles('a'), [uri_1.URI.file('/path/to/aFilename'), uri_1.URI.file('/path/to/aFilename2')]);
            assert.deepEqual(registry.getConfigurationFiles('aname'), []);
            assert.deepEqual(registry.getConfigurationFiles('aName'), []);
        });
    });
