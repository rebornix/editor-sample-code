 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "assert", "vs/editor/common/core/editOperation", "vs/editor/common/core/position", "vs/editor/common/core/range", "vs/editor/common/model/textModel"], function (require, exports, assert, editOperation_1, position_1, range_1, textModel_1) {
    "use strict";
    ...
    suite('Editor Model - Model Decorations', () => {
        ...
        test('removeAllDecorationsWithOwnerId can be called after model dispose', () => {
            let model = textModel_1.TextModel.createFromString('asd');
            model.dispose();
    ...
    suite('deltaDecorations', () => {
        ...
        test('issue #41492: URL highlighting persists after pasting over url', () => {
            ...
            const actual = model.getDecorationRange(id);
            assert.deepEqual(actual, new range_1.Range(1, 1, 1, 1));
            model.dispose();
        });
    });
});
