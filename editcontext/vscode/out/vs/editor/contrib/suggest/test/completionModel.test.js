define(["require", "exports", "assert", "vs/editor/contrib/suggest/completionModel", "vs/editor/contrib/suggest/suggest", "vs/editor/contrib/suggest/wordDistance"], function (require, exports, assert, completionModel_1, suggest_1, wordDistance_1) {
    "use strict";
    ...
    suite('CompletionModel', function () {
        ...
        setup(function () {
            ...
            }, wordDistance_1.WordDistance.None);
        });
        ...
        test('replaceIncomplete', () => {
            ...
            const model = new completionModel_1.CompletionModel([completeItem, incompleteItem], 2, { leadingLineContent: 'f', characterCountDelta: 0 }, wordDistance_1.WordDistance.None);
        ...
        test('Fuzzy matching of snippets stopped working with inline snippet suggestions #49895', function () {
            ...
            const model = new completionModel_1.CompletionModel([
                ...
                completeItem5,
                incompleteItem1,
            ], 2, { leadingLineContent: 'f', characterCountDelta: 0 }, wordDistance_1.WordDistance.None);
            assert.equal(model.incomplete.size, 1);
