...
define(["require", "exports", "assert", "vs/editor/common/model/textModel", "vs/editor/contrib/folding/indentRangeProvider", "vs/editor/contrib/folding/foldingRanges"], function (require, exports, assert, textModel_1, indentRangeProvider_1, foldingRanges_1) {
    ...
    suite('FoldingRanges', () => {
        test('test max folding regions', () => {
            ...
            let actual = indentRangeProvider_1.computeRanges(model, false, markers, foldingRanges_1.MAX_FOLDING_REGIONS);
        ...
        test('findRange', () => {
            ...
            try {
                let actual = indentRangeProvider_1.computeRanges(textModel, false, markers);
                // let r0 = r(1, 2);
                // let r1 = r(3, 12);
                // let r2 = r(4, 11);
                // let r3 = r(5, 6);
