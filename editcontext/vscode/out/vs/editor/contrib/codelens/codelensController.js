                ...
                this._editor.changeViewZones(viewZoneAccessor => {
                    ...
                    while (groupsIndex < groups.length && codeLensIndex < this._lenses.length) {
                        ...
                        if (codeLensLineNumber < symbolsLineNumber) {
                            ...
                            this._lenses.splice(codeLensIndex, 0, new codelensWidget_1.CodeLensWidget(groups[groupsIndex], this._editor, helper, viewZoneAccessor, () => this._detectVisibleLenses.schedule()));
                            codeLensIndex++;
                            groupsIndex++;
                        }
                    }
                    ...
                    while (groupsIndex < groups.length) {
                        this._lenses.push(new codelensWidget_1.CodeLensWidget(groups[groupsIndex], this._editor, helper, viewZoneAccessor, () => this._detectVisibleLenses.schedule()));
                        groupsIndex++;
                    }
                    helper.commit(decorationsAccessor);
                });
