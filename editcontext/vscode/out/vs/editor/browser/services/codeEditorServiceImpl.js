    ...
    class DecorationCSSRules {
        ...
        getCSSTextForModelDecorationContentClassName(opts) {
            ...
            if (typeof opts !== 'undefined') {
                ...
                if (typeof opts.contentIconPath !== 'undefined') {
                    cssTextArr.push(strings.format(_CSS_MAP.contentIconPath, dom.asDomUri(uri_1.URI.revive(opts.contentIconPath)).toString(true).replace(/'/g, '%27')));
                }
        ...
        getCSSTextForModelDecorationGlyphMarginClassName(opts) {
            ...
            if (typeof opts.gutterIconPath !== 'undefined') {
                cssTextArr.push(strings.format(_CSS_MAP.gutterIconPath, dom.asDomUri(uri_1.URI.revive(opts.gutterIconPath)).toString(true).replace(/'/g, '%27')));
