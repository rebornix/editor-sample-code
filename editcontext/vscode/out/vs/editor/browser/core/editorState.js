 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "vs/base/common/strings", "vs/base/common/cancellation", "vs/base/common/lifecycle", "vs/editor/browser/core/keybindingCancellation"], function (require, exports, strings, cancellation_1, lifecycle_1, keybindingCancellation_1) {
    "use strict";
    ...
    class EditorStateCancellationTokenSource extends keybindingCancellation_1.EditorKeybindingCancellationTokenSource {
        constructor(editor, flags, parent) {
            super(editor, parent);
            this.editor = editor;
