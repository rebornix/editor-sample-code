...
define(["require", "exports", "vs/base/common/event", "vs/base/parts/ipc/common/ipc", "vs/base/common/lifecycle", "vs/base/common/buffer", "vs/base/common/platform"], function (require, exports, event_1, ipc_1, lifecycle_1, buffer_1, platform) {
    ...
    exports.createBufferedEvent = createBufferedEvent;
    class QueueElement {
        constructor(data) {
            this.data = data;
            this.next = null;
    ...
    class PersistentProtocol {
        ...
        _recvKeepAliveCheck() {
            ...
            if (timeSinceLastIncomingMsg >= 10000 /* KeepAliveTimeoutTime */) {
                // Trash the socket
            ...
            this._incomingKeepAliveTimeout = setTimeout(() => {
                this._incomingKeepAliveTimeout = null;
                this._recvKeepAliveCheck();
            }, 10000 /* KeepAliveTimeoutTime */ - timeSinceLastIncomingMsg + 5);
        }
        getSocket() {
            return this._socket;
        }
        ...
        _recvAckCheck() {
            ...
            if (timeSinceOldestUnacknowledgedMsg >= 10000 /* AcknowledgeTimeoutTime */) {
                // Trash the socket
                this._onSocketTimeout.fire(undefined);
                return;
            }
            this._outgoingAckTimeout = setTimeout(() => {
                this._outgoingAckTimeout = null;
                this._recvAckCheck();
            }, 10000 /* AcknowledgeTimeoutTime */ - timeSinceOldestUnacknowledgedMsg + 5);
        }
        _sendAck() {
            if (this._incomingMsgId <= this._incomingAckId) {
                // nothink to acknowledge
