 ...
 *--------------------------------------------------------------------------------------------*/
define(["require", "exports", "vs/base/common/assert", "vs/base/common/lifecycle", "vs/base/common/color", "vs/base/common/objects", "vs/base/browser/dom", "vs/base/common/async", "vs/base/common/types", "vs/css!./progressbar"], function (require, exports, assert, lifecycle_1, color_1, objects_1, dom_1, async_1, types_1) {
    "use strict";
    ...
    class ProgressBar extends lifecycle_1.Disposable {
        ...
        doSetWorked(value) {
            assert.ok(types_1.isNumber(this.totalWork), 'Total work not set');
