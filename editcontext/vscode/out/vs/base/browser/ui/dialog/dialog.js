...
define(["require", "exports", "vs/nls", "vs/base/common/lifecycle", "vs/base/browser/dom", "vs/base/browser/event", "vs/base/browser/keyboardEvent", "vs/base/browser/ui/button/button", "vs/base/browser/ui/actionbar/actionbar", "vs/base/common/actions", "vs/base/common/labels", "vs/base/common/platform", "vs/css!./dialog"], function (require, exports, nls, lifecycle_1, dom_1, event_1, keyboardEvent_1, button_1, actionbar_1, actions_1, labels_1, platform_1) {
    "use strict";
        ...
        show() {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                return new Promise((resolve) => {
                    ...
                    if (this.modal) {
                        this._register(event_1.domEvent(this.modal, 'mousedown')(e => {
