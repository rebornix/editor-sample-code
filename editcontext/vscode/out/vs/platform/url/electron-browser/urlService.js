...
define(["require", "exports", "vs/platform/ipc/electron-browser/mainProcessService", "vs/platform/url/node/urlIpc", "vs/platform/url/common/urlService", "vs/platform/opener/common/opener", "vs/platform/product/node/product"], function (require, exports, mainProcessService_1, urlIpc_1, urlService_1, opener_1, product_1) {
    "use strict";
    ...
    let RelayURLService = class RelayURLService extends urlService_1.URLService {
        ...
        open(uri) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                return yield this.urlService.open(uri);
            });
        }
        handleURL(uri) {
