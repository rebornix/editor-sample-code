...
define(["require", "exports", "assert", "vs/platform/storage/common/storage", "vs/base/common/uuid", "vs/base/common/path", "os", "vs/base/node/pfs", "vs/platform/log/common/log", "vs/base/parts/storage/common/storage", "vs/base/common/uri", "vs/platform/files/common/fileService", "vs/base/test/node/testUtils", "vs/platform/files/node/diskFileSystemProvider", "vs/base/common/lifecycle", "vs/base/common/network"], function (require, exports, assert_1, storage_1, uuid_1, path_1, os_1, pfs_1, log_1, storage_2, uri_1, fileService_1, testUtils_1, diskFileSystemProvider_1, lifecycle_1, network_1) {
    ...
    suite('Storage', () => {
        ...
        test('File Based Storage', () => __awaiter(this, void 0, void 0, function* () {
            let storage = new storage_2.Storage(new storage_1.FileStorageDatabase(uri_1.URI.file(path_1.join(testDir, 'storage.json')), fileService));
            yield storage.init();
            storage.set('bar', 'foo');
            ...
            yield storage.close();
            storage = new storage_2.Storage(new storage_1.FileStorageDatabase(uri_1.URI.file(path_1.join(testDir, 'storage.json')), fileService));
            yield storage.init();
            assert_1.equal(storage.get('bar'), 'foo');
            assert_1.equal(storage.get('barNumber'), '55');
            assert_1.equal(storage.get('barBoolean'), 'true');
