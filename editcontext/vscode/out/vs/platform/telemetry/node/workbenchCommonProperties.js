...
define(["require", "exports", "vs/platform/telemetry/node/commonProperties", "vs/platform/telemetry/common/telemetry"], function (require, exports, commonProperties_1, telemetry_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    function resolveWorkbenchCommonProperties(storageService, commit, version, machineId, installSourcePath, remoteAuthority) {
        return __awaiter(this, void 0, void 0, function* () {
            const result = yield commonProperties_1.resolveCommonProperties(commit, version, machineId, installSourcePath);
    ...
    function cleanRemoteAuthority(remoteAuthority) {
        ...
        ['ssh-remote', 'dev-container', 'wsl'].forEach((res) => {
