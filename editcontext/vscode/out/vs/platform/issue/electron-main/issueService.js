...
define(["require", "exports", "vs/nls", "vs/base/common/objects", "vs/platform/environment/node/argv", "electron", "vs/platform/launch/electron-main/launchService", "vs/platform/diagnostics/common/diagnosticsService", "vs/platform/environment/common/environment", "vs/base/common/platform", "vs/platform/log/common/log", "vs/platform/windows/common/windows", "vs/base/node/ps"], function (require, exports, nls_1, objects, argv_1, electron_1, launchService_1, diagnosticsService_1, environment_1, platform_1, log_1, windows_1, ps_1) {
    "use strict";
            ...
            electron_1.ipcMain.on('vscode:listProcesses', (event) => __awaiter(this, void 0, void 0, function* () {
                ...
                try {
                    ...
                    (yield this.launchService.getRemoteDiagnostics({ includeProcesses: true }))
                        .forEach(data => {
                        if (diagnosticsService_1.isRemoteDiagnosticError(data)) {
                            processes.push({
                                name: data.hostName,
                                rootProcess: data
                            });
